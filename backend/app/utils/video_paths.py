...
# Ruta absoluta al directorio del backend (tres niveles hacia arriba)
...
def listar_videos_por_ejercicio(ejercicio: str) -> list[str]:
    ...
    ejercicio_normalizado = re.sub(r"\s+", "", ejercicio, flags=re.UNICODE)
    ...
    return [
        os.path.join("recursos", "videos", ejercicio_normalizado, f).replace("\\", "/")
